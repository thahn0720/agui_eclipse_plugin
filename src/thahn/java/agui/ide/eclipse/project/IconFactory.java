...
public class IconFactory {
     ...
     *         fallbackKey is null
     */
    public ImageDescriptor getImageDescriptor(String key, String fallbackKey) {
        ImageDescriptor id = mImageDescMap.get(key);
        if (id == null && !mImageDescMap.containsKey(key)) {
            id = AbstractUIPlugin.imageDescriptorFromPlugin(
                    AguiPlugin.PLUGIN_ID,
     ...
     */
    public Image addErrorIcon(Image image) {
        if (mErrorIcons != null) {
     ...
     * @return the combined image
     */
    public Image addWarningIcon(Image image) {
        if (mWarningIcons != null) {
