...
import thahn.java.agui.ide.eclipse.project.BaseProjectHelper.IProjectFilter;
...
public class ProjectChooserHelper {
     ...
     */
    private IJavaProject[] mAguiProjects;
...
//            return false;
    ...
    public IJavaProject[] getAndroidProjects(IJavaModel javaModel) {
        ...
        if (mAguiProjects == null || (mFilter != null && mFilter.useCache() == false)) {
            if (javaModel == null) {
                mAguiProjects = BaseProjectHelper.getAndroidProjects(mFilter);
            } else {
                mAguiProjects = BaseProjectHelper.getAndroidProjects(javaModel, mFilter);
            }
        }

        return mAguiProjects;
    }
